...
def clear_sqs_queue_url_cache():
    """Clear the shared alru_cache for SqsWrapper.queue_url between tests to prevent cross-event-loop errors."""
    yield
    wrapper = SqsWrapper.queue_url._LRUCacheWrapperInstanceMethod__wrapper
    wrapper._LRUCacheWrapper__first_loop = None
    wrapper._LRUCacheWrapper__cache.clear()

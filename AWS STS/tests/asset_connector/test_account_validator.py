...
from aws_helpers.base import AWSConfiguration, AWSModule, OidcAwsMixin

FAKE_ASSUME_ROLE = SekoiaAwsConfiguration(
...
class TestAwsAccountValidator:
    ...
    @patch.object(OidcAwsMixin, "get_assume_role", return_value=FAKE_ASSUME_ROLE)
